...
def cleanup():
    ...
    zen imposes a strict shader tree structure for usability and automation.
    ...
    Note: zen puts everything above the Base Shader, thereby requiring that all materials have a
